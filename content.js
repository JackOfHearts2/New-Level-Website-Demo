...
const NAV_MENU = [
  ...
  { label: "About", href: "about.html", children: [
    { label: "About New Level",   href: "about.html" },
    { label: "Team",              href: "team.html" },
    { label: "The Broker's Corner", href: "brokers-corner.html" },
  ] },
...
const FOOTER_NAV = [
  { title: "Company", links: [
    ...
    { label: "Contact",           href: "contact.html" },
    { label: "Join Our Network",  href: "contact.html?topic=join" },
  ] },
...
const FAQS = [
  { q: "How do I get started with New Level?", a: "You can schedule a free initial consultation directly through our website. During this call, we'll learn about your goals and determine which of our services or partnerships best fit your needs." },
  { q: "Do you assist with both buying and selling properties?", a: "Yes. Our licensed professionals guide clients through every stage of the buying or selling process, from market analysis and property valuation to closing." },
  { q: "I'm a licensed agent, can I join New Level?", a: "Yes! We're always open to connecting with talented professionals. Reach out through the Contact page to learn more about current opportunities." },
  { q: "Can I work with your agents if I'm based outside of Florida?", a: "Absolutely. We maintain a network of trusted partners and affiliate agents across several states and can assist you through coordinated local representation." },
  { q: "Does New Level collaborate with outside investors or firms?", a: "Absolutely. Strategic partnerships are a key part of our growth model. If you're interested in co-investing or development collaborations, contact us to schedule a call." },
];

/* Contact page "what's this about?" purpose selector — so the one Contact
   page clearly serves general inquiries, not just property bookings.
   Selecting one just tags the inquiry payload's `topic` field; it doesn't
   change which fields show, keeping this simple. */
...
const EVENTS_CALENDAR = [
  { date: "2026-08-20", title: "New Level Soirée",                  type: "Mixer",      time: "6:00 – 8:00 PM",      blurb: "An exclusive evening of sophistication and opportunity, connecting investors and agents." },
  ...
  { date: "2026-09-19", title: "Crafting Connections Networking Event", type: "Networking", time: "5:00 – 7:00 PM",  blurb: "Meet the team and fellow agents, investors, and partners over drinks and conversation." },
];
...
const I18N = {
  ...
  "About New Level": { es: "Sobre New Level", fr: "À propos de New Level", pt: "Sobre a New Level", ht: "Konsènan New Level" },
  "Frequently Asked Questions": { es: "Preguntas frecuentes", fr: "Foire aux questions", pt: "Perguntas frequentes", ht: "Kesyon yo poze souvan" },
  "Property Inquiry": { es: "Consulta sobre una propiedad", fr: "Demande sur une propriété", pt: "Consulta sobre um imóvel", ht: "Demann sou yon pwopriyete" },
  "Something Else": { es: "Otra cosa", fr: "Autre chose", pt: "Outro assunto", ht: "Yon lòt bagay" },
  "Get in Touch": { es: "Ponte en contacto", fr: "Contactez-nous", pt: "Fale conosco", ht: "Kontakte nou" },
  "Integrity": { es: "Integridad", fr: "Intégrité", pt: "Integridade", ht: "Entegrite" },
  "Excellence": { es: "Excelencia", fr: "Excellence", pt: "Excelência", ht: "Ekselans" },
  "Wealth Creation": { es: "Creación de riqueza", fr: "Création de richesse", pt: "Criação de riqueza", ht: "Kreyasyon richès" },
  "Innovation": { es: "Innovación", fr: "Innovation", pt: "Inovação", ht: "Inovasyon" },
  "Client Focus": { es: "Enfoque en el cliente", fr: "Priorité au client", pt: "Foco no cliente", ht: "Konsantre sou kliyan" },
...
const NLG_BRAND = {
  ...
  mission: "At New Level, we believe real estate should elevate people, communities, and portfolios. Our purpose is to create lasting impact through innovation, integrity, and world-class service.",
  story: "Founded in 2003 and headquartered in South Florida, New Level is a real estate group redefining standards of excellence in brokerage, investment, and property management. What began as a small, ambitious brokerage has evolved into a multi-faceted organization known for its forward-thinking approach and client-first mindset. At its core, New Level is driven by one simple belief: real estate should be redefined at every level, from how investments are made to how relationships are built.",
};

/* Company values — real copy, shown as a small card grid on about.html
   beneath the mission/story text. */
const VALUES = [
  { t: "Integrity",       d: "We conduct every business interaction with honesty and transparency, ensuring our clients feel confident at every step." },
  { t: "Excellence",      d: "From first contact to closing, we pursue precision and professionalism that surpass expectations." },
  { t: "Wealth Creation", d: "Our success is measured by our clients' growth, creating value that endures for generations." },
  { t: "Innovation",      d: "We redefine traditional real estate through forward-thinking solutions and technology-driven insight." },
  { t: "Client Focus",    d: "Our clients are at the center of everything we do, inspiring us to deliver with care, consistency, and commitment." },
];

/* Broker's Corner — Shelley Lozier's market-insight video series. Real
   concept/copy; the video itself is a placeholder until New Level supplies
   one, same convention as every other video slot on this demo. */
const BROKERS_CORNER = {
  tagline: "Real Stories • Real Strategies • Real Results",
  intro: "Welcome to The Broker's Corner, a space where our Principal Broker, Shelley Lozier, shares real stories, strategies, and insights from years in the real estate industry. Whether you're new to investing or an experienced professional, you'll find honest conversations and expert guidance to help you navigate the market with confidence.",
...
const TEAM = [
  { name: "Shelley Lozier", role: "Founder & Principal Broker", motto: "Every detail, followed through.",       placeholder: false },
...
/* Services — copy pulled from the live New Level site. `d` is the short
   blurb used on compact grids (homepage, about.html, the top of
   services.html); `long` + `capabilities` are the fuller dedicated-page
   copy, shown only where buildServices() is called with detailed:true
   (services.html). `id` matches the anchor NAV_MENU's Services dropdown
   already links to (services.html#brokerage etc.). */
const SERVICES = [
  { id: "brokerage", t: "Brokerage & Consulting", d: "Buying or selling is more than a transaction — it's a milestone. Our brokerage team makes every step smooth and transparent, from listing to closing.",
    ...
    capabilities: [
      { t: "Property Acquisition", d: "End-to-end sourcing and negotiation for commercial and residential investments." },
      { t: "Market Analysis",      d: "Comprehensive research and forecasting to identify emerging opportunities." },
      { t: "Deal Structuring",     d: "Custom financing solutions and transaction optimization for maximum value." },
      { t: "Portfolio Strategy",   d: "Holistic planning to diversify holdings and accelerate wealth creation." },
      { t: "Risk Management",      d: "Thorough due diligence and contingency planning to protect your capital." },
    ] },
  { id: "investment", t: "Investments", d: "We help investors find opportunities that match their ambitions and risk comfort — smart, sustainable strategies to help investments grow the right way.",
    ...
    capabilities: [
      { t: "Understand Your Goals",  d: "Every partnership begins with a conversation about your objectives and risk tolerance." },
      { t: "Build Your Strategy",    d: "A clear plan built around target markets, property types, and potential returns." },
      { t: "Identify Opportunities", d: "Sourced and evaluated through our network of trusted partners and off-market access." },
      { t: "Monitor & Grow",         d: "We keep tracking performance and identifying future opportunities as the market evolves." },
    ] },
  { id: "management", t: "Property Management", d: "From tenant relations to maintenance oversight, we take care of the details that protect your property and keep it performing.",
    ...
    capabilities: [
      { t: "Leasing & Tenant Relations", d: "Marketing, tenant screening, lease negotiation, and ongoing relationship management." },
      { t: "Maintenance Coordination",   d: "Preventative scheduling, emergency response, vendor management, and inspections." },
      { t: "Financial Reporting",        d: "Monthly statements, expense tracking, and revenue analysis." },
      { t: "Property Optimization",      d: "Strategic upgrades and rent optimization to enhance value." },
      { t: "Owner Communication",        d: "Transparent, proactive updates on performance and market insights." },
    ] },
  { id: "events", t: "Events & Networking", d: "We love creating spaces where people connect and talk real estate in a way that makes sense — some educational, some just good people swapping ideas.",
